...
The Wordpress page/post editor has two tabs at the top right - "Visual" and "HTML".
...
= Plugin Page =
[Always Edit In HTML](http://www.gravitationalfx.com/always-edit-in-html-wordpress-plugin "Always Edit In HTML WordPress Plugin")
...
Next time you open the same page or post it will open up in HTML mode, removing the "Visual" and "HTML" tabs.

Uncheck the option at any time to get the "Visual" and "HTML" buttons and default opening behaviour back.
